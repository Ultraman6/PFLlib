...
def _generate_dataset(dir_path, transform):
    trainset = TinyImageNet(dir_path+'/rawdata', 'train', transform[0], resolution=64)
    validset = TinyImageNet(dir_path+'/rawdata', 'valid', transform[1], resolution=64)
    testset = TinyImageNet(dir_path+'/rawdata', 'test', transform[2], resolution=64)
    return TensorDataset(trainset, validset, testset)